module github.com/tamalsaha/resource-watcher-demo
...
require (
	...
	kmodules.xyz/client-go v0.0.0-20211216062906-05deba418c82
	kmodules.xyz/resource-metadata v0.7.1-0.20211214035033-fca0c6d60749
